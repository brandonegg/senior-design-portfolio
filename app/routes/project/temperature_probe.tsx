...
export default function TempProbeProjectPage() {
  return (
    <body>
      <div
        className="drop-shadow-lg border-b border-black"
        style={{
      ...
      >
        ...
        >
          ...
          some force. A third box contained a display to read out the
          temperature measured, a button, a battery, and a power switch.
        </p>
        <div
          style={{
            display: "flex",
        ...
        >
          Below is the design flowchart utilized to construct our temperature
          box
        </p>
        <div
          style={{
